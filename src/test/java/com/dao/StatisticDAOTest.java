...
// List<BestSellingDrink> list = statisticDAO.getTop5BestSellingDrinks(fromDate,
// toDate);
...
// @Test
// @Order(3)
// @DisplayName("getTop5BestSellingDrinks() - fromDate và toDate null không gây
// lỗi")
...
// List<BestSellingDrink> list = statisticDAO.getTop5BestSellingDrinks(null,
// null);
// assertNotNull(list);
// }
// }
...
// @Test
// @Order(5)
// @DisplayName("getRevenueByDay() - Không có hóa đơn trong khoảng ngày trả về
// rỗng")
