...
public class BillServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if      (uri.contains("/detail"))      showDetail(req, resp);
        else if (uri.contains("/staff-stats")) showStaffStats(req, resp);
        else                                   listBills(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        String uri = req.getRequestURI();
        if      (uri.contains("/cancel"))  cancelBill(req, resp);
        else if (uri.contains("/complete")) completeBill(req, resp);
        else if (uri.contains("/cleanup")) cleanupJunkBills(req, resp);
    }
    ...
    private void listBills(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (staffFilter == 0) staffFilter = null;
        ...
        for (User u : staffList) staffMap.put(u.getId(), u.getFullName());
