...
<<<<<<< HEAD
                ...
                <div class="-mx-6 -mt-8 relative overflow-hidden"
                    ...
                    <div class="absolute inset-0 opacity-10" style="background-image: radial-gradient(circle at 70% 50%, #ffb68c 0%, transparent 60%),
                    ...
                    <div
                        ...
                        <div>
                            <span
                                class="inline-block py-1 px-3 bg-white/15 text-primary-fixed text-xs font-bold rounded-full mb-4 uppercase tracking-widest">
                                Premium Brewing
                            </span>
                                ...
                                <div
                                    ...
                                    <div class="p-3">
                                        <p class="font-headline font-bold text-sm text-on-surface leading-tight mb-1 overflow-hidden"
                                            style="display: -webkit-box;-webkit-line-clamp: 2;-webkit-box-orient: vertical; overflow: hidden;line-clamp: 2;-webkit-box-orient:vertical">
                                            ${drink.name}
                                        </p>
                                        ...
                                        <c:if test="${sessionScope.user != null}">
                                            <!-- Nhân viên đã đăng nhập: nút thêm nhanh vào
                                                                        phiếu mới -->
                                            <a href="${pageContext.request.contextPath}/employee/bills/create"
                            ...
                            <div>
                                    ...
                                    <c:if test="${sessionScope.user != null}">
                                        ...
                                        <c:if test="${not empty openBills}">
                                            <a href="${pageContext.request.contextPath}/employee/bills"
                                                ...
                                                style="border-color:rgba(255,255,255,0.5);color:white">
                                                <span
                                                    class="material-symbols-outlined text-[20px]">pending_actions</span>
                                                ${openBills.size()} phiếu đang mở
                                            </a>
                                        </c:if>
                                    </c:if>
                                ...
                                <div class="flex gap-8 mt-8">
                                    <div>
                                        ...
                                        <div class="text-sm"
                                            style="color:#F5E6D3;text-shadow:1px 1px 3px rgba(0,0,0,0.3)">Loại đồ uống
                                        </div>
                                    </div>
                                    <div class="border-l border-white/20 pl-8">
                                        <div class="font-headline font-black text-3xl text-white">4.9★</div>
                                        <div class="text-sm"
                                            style="color:#F5E6D3;text-shadow:1px 1px 3px rgba(0,0,0,0.3)">Đánh giá</div>
                                    </div>
                                    <div class="border-l border-white/20 pl-8">
                                        <div class="font-headline font-black text-3xl text-white">1K+</div>
                                        <div class="text-sm"
                                            style="color:#F5E6D3;text-shadow:1px 1px 3px rgba(0,0,0,0.3)">Khách hàng
                                        </div>
                                    </div>
                                </div>
                            </div>
                       ...
                       bg-[#5D4037] text-white shadow">
                                                                ...
                                                                <c:if test="${sessionScope.user != null}">
                                                                    <%-- Nhân viên đã đăng nhập: nút thêm nhanh vào
                                                                        ...
                                                                        <a href="${pageContext.request.contextPath}/employee/bills/create"
                                                                            class="mt-2 btn btn-primary btn-sm w-full text-xs">
                                                                            <span
                                                                                class="material-symbols-outlined text-[14px]">add</span>
                                                                            Đặt ngay
                                                                        </a>
                                                                </c:if>
                                                            </div>
                        ...
                        <%-- Features --%>
                            <div class="mt-16">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div
                                        class="pc-card p-8 group hover:-translate-y-2 transition-transform duration-300">
                                        <div class="w-14 h-14 rounded-2xl bg-primary-fixed flex items-center justify-center mb-6
                        group-hover:bg-primary group-hover:text-white transition-colors">
                                            <span
                                                class="material-symbols-outlined text-primary group-hover:text-white text-2xl">coffee</span>
