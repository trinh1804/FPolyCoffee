                        ...
                        <div class="px-8 pt-8 pb-5" style="background: linear-gradient(135deg, #3d1f0d, #874210);">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-primary-fixed-dim text-xs">Tra cứu tài khoản theo số điện thoại
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <form action="${pageContext.request.contextPath}/quen-tai-khoan" method="post"
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="tel" class="form-control pl-10" name="phone" id="forgotPhone"
                                    ...
                                    <p class="text-xs mt-1" style="color:#9E7B5E">Bắt đầu bằng 0, đúng 10 chữ số
                                    </p>
                                </div>
