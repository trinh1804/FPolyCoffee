...
=======
                                                    <input type="search" id="drinkSearch"
...
=======
                                                        <p id="noResult" class="text-center text-sm py-6 hidden"
                                                            style="color:#9E7B5E">
>>>>>>> origin/Tam
...
<<<<<<< HEAD
                                                        ...
                                                        <%-- Hiển thị mã đang áp dụng + nút Gỡ mã --%>
                                                            <c:if test="${discount != null}">
                                                                <div class="flex items-center justify-between mb-3 px-3 py-2 rounded-lg"
                                                                    ...
                                                                    <form
                                                                        action="${pageContext.request.contextPath}/employee/bills/remove-discount"
                                                                        method="post"
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            <span
                                                                                class="material-symbols-outlined text-[13px]">close</span>
                                                                            Gỡ mã
                                                                        </button>
                                                                    </form>
                                                                </div>
                                            ...
                                            : 'background:#F5E6D3;color:#4A2810;border-color:#C6956A55'}">
                                                                    ...
                                                                    <c:if test="${empty availableDiscounts}">
                                                                        <p class="text-xs" style="color:#9E7B5E">Không
                                                                            có mã nào đang hoạt động.</p>
                                                                    </c:if>
                                                                </div>
                                                                ...
                                                                <%-- Nhập tay --%>
                                                                    <form
                                                                        ...
                                                                        <input type="text" name="discountCode"
                                                                            ...
                                                                            style="border-color:#E8D5C0;outline:none">
                                                                        <button type="submit"
                                                                            class="btn btn-outline btn-sm">Áp
                                                                            dụng</button>
                                                                    </form>
=======
                                                        <c:if test="${discount != null}">
                                                            ...
                                                            <%-- Hiển thị KH đang gán + nút gỡ --%>
                                                                <c:if test="${customer != null}">
                                                                    <div class="flex items-center justify-between mb-3 px-3 py-2 rounded-lg"
                                                                        ...
                                                                        <form
                                                                            action="${pageContext.request.contextPath}/employee/bills/remove-customer"
                                                                            method="post"
                                                                            ...
                                                                            <button type="submit"
                                                                                ...
                                                                                style="background:#FFEBEE;color:#C62828;border:1px solid #FFCDD2">
                                                                                <span
                                                                                    class="material-symbols-outlined text-[13px]">person_remove</span>
                                                                                Gỡ KH
                                                                            </button>
                                                                        </form>
                                                                    </div>
...
=======
                                                            ...
                                                            <%-- Form gán khách hàng: chỉ nhận số điện thoại --%>
                                                                <form
                                                                    action="${pageContext.request.contextPath}/employee/bills/assign-customer"
                                                                    method="post" class="flex gap-2"
                                                                    onsubmit="return validateCustomerPhone()">
                                                                    <input type="hidden" name="billId"
                                                                        value="${bill.id}">
...
=======
                                                                    ...
                                                                    <%-- Nút mở trang QR riêng (dễ quét hơn) — chỉ hiện
                                  ...
                                  text-decoration:none;transition:opacity .15s" onmouseover="this.style.opacity='.85'"
                                        ...
                                        display:flex;align-items:center;justify-content:center;flex-shrink:0">
                                                                                    ...
                                                                                    <div style="flex:1">
                                                                                        <div
                                                                                            style="color:white;font-weight:700;font-size:13px">
                                                                                            MBBank · 0364298183</div>
                                                                                        <div
                                                                                            style="color:rgba(255,255,255,0.75);font-size:11px">
                                                                                            FPOLY COFFEE</div>
                                                                                    </div>
                                        ...
                                        padding:3px 8px;border-radius:20px;letter-spacing:0.5px">VietQR</div>
                                                                                ...
                                                                                <div
                                                                                    style="background:white;padding:16px;text-align:center">
                                                                                    <div id="qrLoading"
                                            ...
                                            border-radius:50%;animation:spin .8s linear infinite;margin:0 auto 8px">
                                                                                        ...
                                                                                        <span
                                                                                            style="font-size:12px;color:#666">Đang
                                                                                            tạo mã QR...</span>
                                                                                    </div>
                                                                                    ...
                                                                                    <div id="qrError"
                                                                                        ...
                                                                                        <p
                                                                                            style="font-size:12px;color:#999;margin:4px 0">
                                                                                            Không tải được QR —
                                                                                            <a id="qrLink" href="#"
                                                                                                target="_blank"
                                                                                ...
                                                                                <div
                                                                                    style="background:#F0F6FF;padding:10px 14px;font-size:12px">
                                                                                    <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <span style="color:#666">Số
                                                                                            tiền</span>
                                                                                        <span
                                                                                            style="font-weight:700;color:#003F8A;font-size:13px">
                                                                                            <fmt:formatNumber
                                                                                                value="${bill.totalPrice}"
                                                                                                pattern="#,##0" />
                                                                                            &#8363;
                                                                                ...
                                                                                <div
                                                                                    style="background:#FFFBEB;border-top:1px solid #FDE68A;padding:8px 12px">
                                                                                    <div
                                                                                        ...
                                                                                        <span
                                                                                            style="font-size:11px;color:#92400E">Sau
                                                                                    ...
                                                                                    <button type="button" id="copyBtn"
                                                                                        ...
                                                                                        style="width:100%;padding:7px;border-radius:8px;background:#EBF3FF;color:#1565C0;
...
=======
                            ...
                            const BILL_TOTAL = Math.round(${ bill.totalPrice });
