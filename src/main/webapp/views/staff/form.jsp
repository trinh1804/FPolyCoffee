                    ...
                    <div class="pc-card">
                        ...
                        <div class="p-6">
                            <form
                                ...
                                method="post" onsubmit="return validateStaffForm()">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" class="form-control pl-10" name="fullName"
                                            value="${staff.fullName}" placeholder="Nhập họ và tên đầy đủ" required
                                            maxlength="255" oninput="this.value=this.value.replace(/[0-9]/g,'')">
                                    </div>
                                    <p class="text-xs mt-1" style="color:#9E7B5E">Chỉ nhập chữ, không
                                        nhập số</p>
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="tel" class="form-control pl-10" name="phone" value="${staff.phone}"
                                            placeholder="0xxxxxxxxx" required maxlength="10" pattern="0[0-9]{9}"
                                            title="Số điện thoại phải bắt đầu bằng 0 và có đúng 10 chữ số"
                                            oninput="this.value=this.value.replace(/\D/g,'').slice(0,10)">
                                    </div>
                                    <p class="text-xs mt-1" style="color:#9E7B5E">Bắt đầu bằng
                                        0, đúng 10 chữ số</p>
                                </div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="text" class="form-control pl-10" name="password"
                                                id="staffPassword"
                                                placeholder="Để trống để dùng mật khẩu mặc định: 123456" minlength="6"
                                                maxlength="255">
                                        </div>
                                        <p class="text-xs mt-1" style="color:#9E7B5E">
                                            Mật khẩu mặc định: <strong>123456</strong>. Nếu
                                            nhập phải từ 6 ký tự trở lên.
                                        </p>
                                    </div>
                                </c:if>
                                ...
                                <div class="flex gap-3 pt-2">
                                    <button type="submit" class="btn btn-primary flex-1 py-3">
                                        ...
                                        ${empty staff ? 'Thêm nhân viên' : 'Lưu thay
                                        đổi'}
                                    </button>
