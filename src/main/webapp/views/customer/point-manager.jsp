                            ...
                            <div class="flex gap-3 items-end flex-wrap">
                                <div class="flex-1 min-w-[200px]">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="tel" class="form-control pl-10" name="phone" id="searchPhone"
                                            value="${phone}" placeholder="0xxxxxxxxx" maxlength="10" pattern="0[0-9]{9}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                        <div class="stat-card">
                            <div class="stat-icon" style="background:linear-gradient(135deg,#F5E6D3,#E8D5C0)">
                                <span class="material-symbols-outlined"
                                    style="color:#8B4513;font-size:28px">person</span>
                            </div>
                            <div>
                                <p
                                    style="font-size:0.75rem;font-weight:600;text-transform:uppercase;letter-spacing:0.07em;color:#9E7B5E">
                                    Khách hàng</p>
                                <p
                                    style="font-family:'Playfair Display',serif;font-size:1.1rem;font-weight:700;color:#2C1A0E">
                                    ${customer.fullName}</p>
                        ...
                        <div class="stat-card" style="background:linear-gradient(135deg,#FFF8E1,#FFF3E0)">
                            <div class="stat-icon" style="background:rgba(212,160,23,0.15)">
                                <span class="material-symbols-outlined"
                                    style="color:#D4A017;font-size:28px">stars</span>
                            </div>
                            <div>
                                <p
                                    style="font-size:0.75rem;font-weight:600;text-transform:uppercase;letter-spacing:0.07em;color:#9E7B5E">
                                    Điểm hiện tại</p>
                                <p
                                    style="font-family:'Playfair Display',serif;font-size:2rem;font-weight:900;color:#D4A017">
                                    ${customer.point}</p>
                                <p style="font-size:0.8rem;color:#8B6914">≈
                                    <fmt:formatNumber value="${customer.point * 1000}" pattern="#,##0" /> ₫ giảm
                                    giá
                                </p>
                            </div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-icon">
                                <span class="material-symbols-outlined"
                                    style="color:#8B4513;font-size:28px">calendar_today</span>
                            </div>
                            <div>
                                <p
                                    style="font-size:0.75rem;font-weight:600;text-transform:uppercase;letter-spacing:0.07em;color:#9E7B5E">
                                ...
                                <p style="font-size:0.85rem;color:#6B3A1F">${customer.active ? 'Đang hoạt động'
                                    : 'Đã khóa'}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
                        ...
                        <div class="pc-card">
                            <div class="pc-card-header" style="background:linear-gradient(135deg,#E8F5E9,#C8E6C9)">
                                <span class="material-symbols-outlined"
                                    style="color:#2E7D32;font-size:18px">add_circle</span>
                            ...
                            <div class="p-5">
                                <form action="${pageContext.request.contextPath}/manager/customer-points/add-bonus"
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Số điểm cộng <span
                                                style="color:#C62828">*</span></label>
                                        <input type="number" class="form-control" name="points" id="addPoints" min="1"
                                            max="9999" placeholder="VD: 50" required
                                            oninput="this.value=this.value.replace(/[^0-9]/g,'')">
                                        <p class="text-xs mt-1" style="color:#9E7B5E">Nhập số nguyên từ
                                            1 đến 9999</p>
                                    </div>
                                    <div class="mb-4">
                        ...
                        <div class="pc-card">
                            <div class="pc-card-header" style="background:linear-gradient(135deg,#FFEBEE,#FFCDD2)">
                                <span class="material-symbols-outlined"
                                    style="color:#C62828;font-size:18px">remove_circle</span>
                                <span style="color:#C62828">Trừ điểm thủ công</span>
                            </div>
                            <div class="p-5">
                                <form action="${pageContext.request.contextPath}/manager/customer-points/deduct"
                                    method="post" data-point="${customer.point}"
                                    onsubmit="return validatePoints('deductPoints', 1, Number(this.dataset.point || 0))">
                                    <input type="hidden" name="customerId" value="${customer.id}">
                                    <div class="mb-4">
                                        <label class="form-label">Số điểm trừ <span
                                                style="color:#C62828">*</span></label>
                                                ...
                                                <c:choose>
                                                    <c:when test="${c.point > 0}">
                                                        <span class="badge badge-gold">
                                                            <span
                                                                class="material-symbols-outlined text-[12px]">stars</span>
                                                            ${c.point}
                                                        </span>
                                                    </c:when>
                                                    <c:otherwise>
