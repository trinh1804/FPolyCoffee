...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        h1,h2,h3,h4,h5,.display { font-family: 'Playfair Display', Georgia, serif; }
        ...
        .nav-link:hover { color: #F5E6D3; background: rgba(255,255,255,0.10); }
        .nav-link.active { color: #D4A017; background: rgba(212,160,23,0.15); }
        ...
        .dropdown-item:hover { background: #F5E6D3; color: #2C1A0E; }
        .dropdown-item .material-symbols-outlined { color: #8B4513; font-size: 18px; }
        .dropdown-divider { height: 1px; background: #E8D5C0; margin: 0.375rem 0; }
        ...
        .mobile-link {
            ...
            color: #F5E6D3; font-size: 0.9rem; font-weight: 500;
            text-decoration: none; border-bottom: 1px solid rgba(197,149,106,0.12);
            transition: background .15s;
        }
        .mobile-link:hover { background: rgba(255,255,255,0.07); }
        .mobile-link .material-symbols-outlined { color: #C6956A; font-size: 20px; }
        ...
        .btn:hover { transform: translateY(-1px); box-shadow: 0 4px 12px rgba(44,26,14,0.2); }
        .btn:active { transform: scale(0.97); box-shadow: none; }
        .btn-primary { background: #4A2810; color: #F5E6D3; }
        .btn-primary:hover { background: #2C1A0E; color: #F5E6D3; }
        .btn-secondary { background: #F5E6D3; color: #4A2810; }
        .btn-secondary:hover { background: #E8D5C0; }
        .btn-outline {
            background: transparent; color: #4A2810;
            border: 1.5px solid #C6956A;
        }
        .btn-outline:hover { background: #F5E6D3; border-color: #8B4513; }
        .btn-danger { background: #FFEBEE; color: #C62828; border: 1.5px solid #FFCDD2; }
        .btn-danger:hover { background: #C62828; color: white; }
        .btn-success { background: #E8F5E9; color: #2E7D32; border: 1.5px solid #C8E6C9; }
        .btn-success:hover { background: #2E7D32; color: white; }
        .btn-sm { padding: 0.25rem 0.75rem; font-size: 0.8rem; }
        .btn-lg { padding: 0.75rem 2rem; font-size: 1rem; }
        .btn-icon { padding: 0.375rem; border-radius: 0.625rem; }

        /* ─── Form controls ─── */
        .form-label {
            font-weight: 600; font-size: 0.875rem; color: #4A2810;
            margin-bottom: 0.375rem; display: block;
        }
        .form-control {
            width: 100%; padding: 0.625rem 0.875rem;
            border: 1.5px solid #C6956A33;
            border-radius: 0.625rem; font-size: 0.9rem;
            background: white; transition: all .2s; outline: none;
            font-family: 'DM Sans', sans-serif; color: #2C1A0E;
        }
        .form-control:focus { border-color: #8B4513; box-shadow: 0 0 0 3px rgba(139,69,19,.12); }
        .form-select {
            width: 100%; padding: 0.625rem 0.875rem;
            border: 1.5px solid #C6956A33;
            border-radius: 0.625rem; font-size: 0.9rem;
            background: white; font-family: 'DM Sans', sans-serif; color: #2C1A0E;
            cursor: pointer;
        }
        .form-select:focus { border-color: #8B4513; box-shadow: 0 0 0 3px rgba(139,69,19,.12); outline: none; }
        ...
        .badge-neutral  { background: #F3F0EB; color: #5D4037; }
        .badge-gold     { background: #FFF8E1; color: #8B6914; }
        .badge-secondary{ background: #F5E6D3; color: #6B3A1F; }
        .badge-primary  { background: #4A2810; color: #F5E6D3; }
        ...
        .data-table th {
            ...
            color: #6B3A1F; padding: 0.75rem 1rem;
        }
        .data-table td { padding: 0.875rem 1rem; border-bottom: 1px solid #F0E6DA; font-size: 0.9rem; }
        .data-table tbody tr:hover { background: #FDF5EE; }
        ...
        .page-btn {
            ...
            color: #6B3A1F; background: white; text-decoration: none;
            display: inline-flex; align-items: center;
        }
        .page-btn:hover { border-color: #8B4513; color: #4A2810; background: #F5E6D3; }
        .page-btn.active { background: #4A2810; color: #F5E6D3; border-color: #4A2810; }
        ...
        .stat-card {
            ...
            padding: 1.25rem; border: 1px solid #EDE0D4;
        ...
        .stat-icon .material-symbols-outlined { color: #8B4513; font-size: 26px; }

        /* ─── Scrollbar ─── */
        ::-webkit-scrollbar { width: 6px; height: 6px; }
        ::-webkit-scrollbar-track { background: #F5E6D3; }
        ::-webkit-scrollbar-thumb { background: #C6956A; border-radius: 9999px; }
    ...
    <nav class="nav-glass fixed top-0 w-full z-50">
                ...
                <c:if test="${sessionScope.user != null}">
                    ...
                    <div class="nav-dropdown">
                        <button class="nav-link">
                            ...
                            Bán hàng
                            <span class="material-symbols-outlined text-[14px]" style="color:rgba(245,230,211,0.5)">expand_more</span>
                        </button>
                        <div class="nav-dropdown-menu">
                            <a href="${pageContext.request.contextPath}/employee/bills/create" class="dropdown-item">
                                <span class="material-symbols-outlined">add_circle</span> Tạo phiếu mới
                            </a>
                            <a href="${pageContext.request.contextPath}/employee/bills" class="dropdown-item">
                ...
                <c:if test="${sessionScope.user != null && sessionScope.user.roleId == 1}">
                    ...
                    <div class="nav-dropdown">
                        ...
                        <div class="nav-dropdown-menu" style="min-width:240px">
                            ...
                            <a href="${pageContext.request.contextPath}/manager/discount-codes" class="dropdown-item">
                                <span class="material-symbols-outlined">local_offer</span> Mã giảm giá
                            </a>
                            <a href="${pageContext.request.contextPath}/manager/customer-points" class="dropdown-item">
                                <span class="material-symbols-outlined">loyalty</span> Điểm thưởng
                            </a>
                            <div class="dropdown-divider"></div>
                            <a href="${pageContext.request.contextPath}/manager/report" class="dropdown-item">
                                <span class="material-symbols-outlined">bar_chart</span> Báo cáo & Thống kê
                            </a>
                        </div>
                    </div>
                </c:if>
                        ...
                        <div class="nav-dropdown">
                            <div class="user-pill">
                                ...
                                <c:if test="${sessionScope.user.roleId == 1}">
                                    <span class="badge badge-gold text-[10px] py-0.5 px-1.5">Admin</span>
                                </c:if>
                                <span class="material-symbols-outlined text-[14px] opacity-60">expand_more</span>
                            </div>
                            <div class="nav-dropdown-menu" style="left:auto;right:0;transform:translateX(0) translateY(-6px)">
                                <a href="${pageContext.request.contextPath}/thong-tin-ca-nhan" class="dropdown-item">
                                    <span class="material-symbols-outlined">manage_accounts</span> Thông tin cá nhân
                                </a>
                                <a href="${pageContext.request.contextPath}/doi-mat-khau" class="dropdown-item">
                                    <span class="material-symbols-outlined">lock_reset</span> Đổi mật khẩu
                                </a>
                                <div class="dropdown-divider"></div>
                                <a href="${pageContext.request.contextPath}/dang-xuat" class="dropdown-item"
                                   style="color:#C62828">
                                    <span class="material-symbols-outlined" style="color:#C62828">logout</span> Đăng xuất
                                </a>
                            </div>
                        </div>
                    </c:when>
        ...
        <div id="mobileMenu">
            ...
            <c:if test="${sessionScope.user != null && sessionScope.user.roleId == 1}">
                ...
                <a href="${pageContext.request.contextPath}/manager/customer-points" class="mobile-link">
                    <span class="material-symbols-outlined">loyalty</span> Điểm thưởng
                </a>
            ...
            <c:if test="${sessionScope.user != null}">
                <a href="${pageContext.request.contextPath}/dang-xuat" class="mobile-link" style="color:#FFAB91">
                    <span class="material-symbols-outlined" style="color:#FFAB91">logout</span> Đăng xuất
                </a>
            </c:if>
        </div>
    </nav>
