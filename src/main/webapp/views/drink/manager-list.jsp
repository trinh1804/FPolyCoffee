            ...
            <%@ include file="/views/layout/header.jsp" %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="flex items-center justify-center gap-1.5">
                                                ...
                                                <button class="btn btn-secondary btn-icon" title="Sửa"
                                                    ...
                                                    data-active="${drink.active}" onclick="openEditModalFromBtn(this)">
                                                ...
                                                <form
                                                    ...
                                                    data-msg="${drink.active ? 'Ngừng bán đồ uống này?' : 'Mở bán lại đồ uống này?'}"
                    ...
                    <div class="modal-box">
                        ...
                        <div class="p-6">
                            <form action="${pageContext.request.contextPath}/manager/drinks/edit" method="post"
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Mô tả</label>
                                    <textarea class="form-control" id="editDrinkDesc" name="description" rows="2"
                                        maxlength="500"></textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">
                                        Hình ảnh mới
                                        <span style="font-size:0.78rem;color:#9E7B5E;font-weight:400">(để
                ...
                <script>
                    ...
                    function openEditModalFromBtn(btn) {
                        ...
                        openEditModal(id, name, price, categoryId, description, active);
                    }
                </script>
