    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ include file="/views/layout/header.jsp" %>
            ...
            <c:if test="${not empty message}">
                <div class="alert alert-success"><span class="material-symbols-outlined text-[18px]">check_circle</span>
                    ${message}</div>
            </c:if>
                                ...
                                <tbody>
                                    <c:forEach items="${list}" var="cat">
                                        <tr>
                                            ...
                                            <td>
                                                <span class="font-headline font-bold text-on-surface">${cat.name}</span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="flex items-center justify-center gap-1.5">
                                                    ...
                                                    <!-- Nút Ẩn/Hiện (toggle) thay vì Xóa -->
                                                    <form
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            title="${cat.active ? 'Ẩn danh mục' : 'Hiện lại danh mục'}">
                                                            <span class="material-symbols-outlined text-[15px]">
                                                                ${cat.active ? 'visibility_off' : 'visibility'}
                                                            </span>
                                                            <span class="text-xs">${cat.active ? 'Ẩn' : 'Hiện'}</span>
                                                        </button>
                                                    </form>
                                                </div>
                                            </td>
                ...
                <c:if test="${category != null}">
                    <div class="lg:col-span-1">
                        <div class="pc-card sticky top-24">
                            <div class="pc-card-header" style="background: linear-gradient(135deg, #3d1f0d, #874210);">
                            ...
                            <div class="p-5">
                                <form action="${pageContext.request.contextPath}/manager/categories/edit" method="post"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="file" class="form-control text-sm" name="image" accept="image/*">
