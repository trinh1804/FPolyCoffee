                ...
                <c:forEach items="${drinks}" var="drink">
                    <tr>
                        ...
                        <td>
                            ...
                            <p style="font-size:0.78rem;color:#9E7B5E;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:180px">${drink.description}</p>
                        </td>
    ...
    <div class="modal-box">
        ...
        <div class="p-6">
            <form action="${pageContext.request.contextPath}/manager/drinks/add" method="post"
                  enctype="multipart/form-data" onsubmit="return validateDrinkForm('add')">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" class="form-control" name="price" id="addPrice"
                               placeholder="35000" required min="1000" max="10000000" step="1000"
                               oninput="this.value=this.value.replace(/[^0-9]/g,'')">
                        <p class="text-xs mt-1" style="color:#9E7B5E">Tối thiểu 1.000 ₫, bội số 1.000</p>
                    </div>
                    <div>
    ...
    <div class="modal-box">
        ...
        <div class="p-6">
            <form action="${pageContext.request.contextPath}/manager/drinks/edit" method="post"
                  enctype="multipart/form-data" onsubmit="return validateDrinkForm('edit')">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" class="form-control" id="editDrinkPrice" name="price"
                               ...
                               oninput="this.value=this.value.replace(/[^0-9]/g,'')">
                        <p class="text-xs mt-1" style="color:#9E7B5E">Tối thiểu 1.000 ₫</p>
                    </div>
                    <div>
                        <label class="form-label">Danh mục <span style="color:#C62828">*</span></label>
                ...
                <div class="mb-4">
                    <label class="form-label">Mô tả</label>
                    <textarea class="form-control" id="editDrinkDesc" name="description" rows="2" maxlength="500"></textarea>
                </div>
                <div class="mb-4">
                    <label class="form-label">
                        Hình ảnh mới
                        <span style="font-size:0.78rem;color:#9E7B5E;font-weight:400">(để trống giữ ảnh cũ)</span>
                    </label>
                    <input type="file" class="form-control" name="image" accept="image/*">
                </div>
                <div class="flex items-center gap-2 mb-5">
