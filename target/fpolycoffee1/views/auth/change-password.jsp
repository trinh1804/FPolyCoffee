                        ...
                        <div class="px-8 pt-8 pb-5" style="background: linear-gradient(135deg, #3d1f0d, #874210);">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-primary-fixed-dim text-xs">Cập nhật mật khẩu đăng nhập của bạn
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <form action="${pageContext.request.contextPath}/doi-mat-khau" method="post"
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="password" class="form-control pl-10" name="oldPassword"
                                            id="oldPassword" placeholder="Nhập mật khẩu hiện tại" minlength="1"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="password" class="form-control pl-10" name="newPassword"
                                            id="newPassword" placeholder="Tối thiểu 6 ký tự" minlength="6" required
                                            oninput="clearConfirmError()">
                                    </div>
                                    <p class="text-xs mt-1" style="color:#9E7B5E">Mật khẩu phải có ít nhất 6 ký
                                        tự</p>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="password" class="form-control pl-10" name="confirmPassword"
                                            ...
                                            required oninput="clearConfirmError()">
                                    </div>
                                ...
                                <div class="flex gap-3">
                                    <button type="submit" class="btn btn-primary flex-1 py-3">
                                        <span class="material-symbols-outlined text-[18px]">check</span> Đổi mật
                                        khẩu
                                    </button>
