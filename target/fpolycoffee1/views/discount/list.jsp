                            ...
                            <table class="data-table w-full">
                                ...
                                <tbody>
                                    <c:forEach items="${list}" var="dc">
                                        <%-- BUG FIX CHÍNH: Dùng fmt:formatDate với var="" để lưu vào biến JSP, rồi đặt
                                            vào data-* attribute của button. Tránh hoàn toàn việc nhúng tag JSP bên
                                            trong chuỗi onclick="..." — đây là nguyên nhân gây blank page (JSP parser
                                            lỗi). --%>
                                            ...
                                            <tr>
                                                <td class="font-mono font-bold"
                                                    style="color:#4A2810;letter-spacing:0.05em">
                                                    ${dc.code}
                                                </td>
                                                ...
                                                <td class="text-right font-semibold" style="color:#2C1A0E">
                                                    <c:choose>
                                                        <c:when test="${dc.discountType}">
                                                            <fmt:formatNumber value="${dc.discountValue}"
                                                                pattern="#,##0" />%
                                                        </c:when>
                                                        <c:otherwise>
                                                            <fmt:formatNumber value="${dc.discountValue}"
                                                ...
                                                <td class="text-center text-sm"
                                                    style="color:#6B3A1F;white-space:nowrap">
                                                    ${dStart} → ${dEnd}
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="flex items-center justify-center gap-1.5">
                                                        ...
                                                        <%-- Nút Sửa: toàn bộ data đặt trong data-* attribute --%>
                                                            <button type="button"
                                                                class="btn btn-secondary btn-sm js-edit-dc" title="Sửa"
                                                                data-id="${dc.id}" data-code="${dc.code}"
                                                            ...
                                                            <%-- Toggle --%>
                                                                <form
                                                                    ...
                                                                    <button type="submit"
                                                                        ...
                                                                        onclick="return confirm('${dc.active ? 'Vô hiệu hoá' : 'Kích hoạt'} mã ${dc.code}?')">
                                                                        <span
                    ...
                    <%-- ══ ADD MODAL ══ --%>
                        <div id="addModal" class="modal-backdrop" style="display:none"
                            ...
                            <div class="modal-box">
                                ...
                                <div class="p-6">
                                    <form action="${pageContext.request.contextPath}/manager/discount-codes/add"
                                        method="post">

                                        <div class="mb-4">
                                            <label class="form-label">Mã code <span
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="number" class="form-control" name="discountValue" id="addValue"
                                                min="1" step="1" placeholder="VD: 20000" required>
                        ...
                        <%-- ══ EDIT MODAL ══ --%>
                            <div id="editModal" class="modal-backdrop" style="display:none"
                                ...
                                <div class="modal-box">
                                    <div class="modal-header">
                                        <span
                                            style="font-family:'Playfair Display',serif;font-weight:700;color:#F5E6D3">
                                    ...
                                    <div class="p-6">
                                        <form action="${pageContext.request.contextPath}/manager/discount-codes/edit"
                                            method="post">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="text" id="editCode" class="form-control font-mono"
                                                    style="font-weight:700;letter-spacing:0.05em;background:#F5F5F5"
                                                    readonly>
                                            ...
                                            <%-- step="1" — không dùng step="1000" vì gây lỗi HTML5 validation bội số
                                                khi nhập % --%>
                                                <div class="mb-4">
                                                    ...
                                                    <input type="number" class="form-control" id="editValue"
                                                        name="discountValue" min="1" step="1" required>
                                                    <p style="font-size:0.75rem;color:#9E7B5E;margin-top:4px"
                                                        id="editValueHint">
                                                        Nhập số tiền giảm (VNĐ)
                                                    </p>
