        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex gap-2 mt-5">
                    <a href="#" class="footer-icon-btn" style="width:34px;height:34px;border-radius:8px;
            ...
            <div>
                ...
                <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:0.6rem">
                    <li><a href="${pageContext.request.contextPath}/trang-chu" class="footer-link" style="color:rgba(245,230,211,0.70);font-size:0.875rem;text-decoration:none;
                            ...
                            <span class="material-symbols-outlined text-[14px]"
                                style="color:#8B4513">arrow_forward_ios</span>
                            Trang chủ & Thực đơn
                        </a></li>
                    <li><a href="${pageContext.request.contextPath}/employee/bills" class="footer-link" style="color:rgba(245,230,211,0.70);font-size:0.875rem;text-decoration:none;
                                      transition:color .15s;display:flex;align-items:center;gap:0.5rem"
                            onmouseover="this.style.color='#F5E6D3'"
                            onmouseout="this.style.color='rgba(245,230,211,0.70)'">
                            <span class="material-symbols-outlined text-[14px]"
                    ...
                    <li><a href="${pageContext.request.contextPath}/manager/report" class="footer-link" style="color:rgba(245,230,211,0.70);font-size:0.875rem;text-decoration:none;
                                      transition:color .15s;display:flex;align-items:center;gap:0.5rem"
                            onmouseover="this.style.color='#F5E6D3'"
                            onmouseout="this.style.color='rgba(245,230,211,0.70)'">
                            <span class="material-symbols-outlined text-[14px]"
                ...
                <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:0.75rem">
                    <li style="display:flex;align-items:flex-start;gap:0.625rem">
                        <span class="material-symbols-outlined text-[16px]"
                            style="color:#C6956A;margin-top:1px">location_on</span>
                    ...
                    <li style="display:flex;align-items:center;gap:0.625rem">
                        ...
                        <span style="color:rgba(245,230,211,0.70);font-size:0.875rem">(028)
                            1234 5678</span>
                    </li>
                    <li style="display:flex;align-items:center;gap:0.625rem">
            ...
            <div>
                ...
                <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:0.625rem">
                    <li style="display:flex;justify-content:space-between;gap:1rem">
                        <span style="color:rgba(245,230,211,0.65);font-size:0.875rem">Thứ
                            2 – Thứ 6</span>
                        <span style="color:#F5E6D3;font-size:0.875rem;font-weight:600">7:00
                            – 22:00</span>
                    </li>
                    <li style="display:flex;justify-content:space-between;gap:1rem">
                        <span style="color:rgba(245,230,211,0.65);font-size:0.875rem">Thứ
                            7</span>
                        <span style="color:#F5E6D3;font-size:0.875rem;font-weight:600">8:00
                            – 23:00</span>
                    </li>
                    <li style="display:flex;justify-content:space-between;gap:1rem">
                        <span style="color:rgba(245,230,211,0.65);font-size:0.875rem">Chủ
                            nhật</span>
                        <span style="color:#F5E6D3;font-size:0.875rem;font-weight:600">8:00
                            – 23:00</span>
                    </li>
                    <li style="margin-top:0.5rem;padding:0.625rem 0.875rem;border-radius:0.75rem;
                        ...
                        <span style="color:#D4A017;font-size:0.8rem;font-weight:600">Đang
                            mở cửa</span>
                    </li>
                </ul>
            </div>
